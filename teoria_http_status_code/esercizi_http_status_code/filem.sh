...
echo ""
echo -e "  Chiamiamo /url-sbagliato e  httpbin non la conosce."
echo ""
echo -e "  ${GREEN}curl -s -o /dev/null -w '  → Status: %{http_code}\\n' \\${RESET}"
echo -e "  ${GREEN}     $BASE/url-sbagliato${RESET}"
echo ""
