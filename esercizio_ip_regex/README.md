# Esercizio con `egrep` — IPv4 Regex

**Obiettivo:** scrivere un'espressione regolare che matchi tutti e soli i valori IPv4 validi in *decimal dotted notation* (es. `192.168.1.1`).
